...
class PersonalAccessGrantTest extends TestCase
{
    ...
    public function test_it_generate_access_token_with_no_both_personal_token__ok()
    {
    ...
    public function test_it_generate_access_token_with_no_first_personal_token__ok()
    {
        $personal_access = DB::table('oauth_personal_access_clients')
            ->where('client_id', $this->client->{'id'})
            ->first();
